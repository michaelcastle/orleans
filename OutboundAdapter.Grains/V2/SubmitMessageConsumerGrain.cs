...
//    {
//        Task Subscribe(Guid streamId, string streamNamespace, string providerToUse);
//        Task Unsubscribe();
...
//        public async Task Subscribe(Guid streamId, string streamNamespace, string providerToUse)
//        {
